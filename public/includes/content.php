  ...
  <div class="content-body">
    <form action="./public/edit-user.php?id=<?php echo $_GET['id'] ?? '' ?>" method="post" name="edit-user">
      <div class="row content-form">
        ...
        <div class="col-xs-12 col-sm-4 form-group">
          <label for="fechanacimiento">Fecha de nacimiento</label>
          <input class="form-control" type="text" name="nacimiento" id="nacimiento" maxlength="255" value="<?php echo $user ? $user->getNacimiento() : ''; ?>" required>
        </div>

        <div class="col-xs-12 form-group">
          <button class="btn btn-block" name="submit">Editar Usuario</button>
        </div>
      </div>
    </form>
  </div>
